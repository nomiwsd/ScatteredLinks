...
import applicationimg from "../../assets/Untitled design (18).webp";
import secondimg from "../../assets/Untitled design (17).webp";
import cardimg1 from "../../assets/Untitled design (23).webp";
import cardimg3 from "../../assets/Untitled design (22).webp";
import cardimg2 from "../../assets/Untitled design (15).webp";
  ...
  return (
    <section>
      <div className="relative" ref={videoRef}>
        <div className="relative w-full h-[400px] md:h-[520px] lg:h-[540px]">
          <video
            ...
            loop
            muted
            className="object-cover w-full h-[400px] md:h-[520px] lg:h-[540px]  absolute top-0 left-0 z-[-1]"
          >
      ...
      <div className="mt-20 pb-10 px-4 md:px-10 w-full">
        <div className="bg-[#CED5D6] py-20 md:px-20 lg:px-2 xl:px-30">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-4 justify-center items-center md:px-20">
            <div className="relative overflow-hidden">
              ...
              >
                <h1 className="font-bold font-raleway text-base pb-2">
                  Custom Solutions
                </h1>
                <p className="font-medium font-raleway text-sm">
